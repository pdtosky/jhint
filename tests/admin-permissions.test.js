...
assert(appJs.includes('production: ["dashboardView", "workerView", "sopView", "chatView"]'), "production role should also access company chat");
assert(appJs.includes('admin: ["dashboardView", "ordersView", "requisitionView", "workerView", "shippingView", "sopView", "adminView", "chatView"]'), "administrator role should access company chat");
assert(appJs.includes('office: ["dashboardView", "ordersView", "requisitionView", "workerView", "shippingView", "sopView", "adminView", "chatView"]'), "office role should access company chat");
...
assert(appJs.includes('sales: ["dashboardView", "requisitionView", "ordersView", "shippingView", "sopView", "chatView"]'), "sales role should also access company chat");
assert(
  appJs.includes('["admin", "office", "quality"].includes(currentAdminRole)'),
  "sales users should not receive SOP document editing permission"
);
assert(appJs.includes('shipping: ["dashboardView", "shippingView", "chatView"]'), "shipping role should also access company chat");
assert(appJs.includes('quality: ["dashboardView", "ordersView", "requisitionView", "workerView", "shippingView", "sopView", "chatView"]'), "quality role should also access company chat");
