...
assert(indexHtml.includes("app.js?v=20260901-12"), "the app script should use the current cache version");
assert(indexHtml.includes("config.js?v=20260901-07"), "the config script should use the current cache version");
